...
function Portfolio() {
  return (
    <div style={{backgroundColor: 'black', color: 'white', marginBottom: '0px', display: 'flex', flexDirection: 'row', fontFamily: 'roboto', height: '100vh', width: '100%'}}>
      ...
      <Card.Body>
        <Card.Title style={{color: 'black'}}>WYD</Card.Title>
        ...
        <Button variant="primary" href="https://peaceful-reef-29677.herokuapp.com/" target="_">Check it out!</Button>
      </Card.Body>
    </Card>
      </div>
      ...
      <Card.Body>
        <Card.Title style={{color: 'black'}}>Market Moment</Card.Title>
        <Card.Text style={{color: 'black'}}>
        ...
        <Button variant="primary" href="https://brandtdavidson.github.io/interactive-stock/" target="_">Check it out!</Button>
      </Card.Body>
    </Card>
      </div>
      <div>
      ...
      <Card.Body>
        <Card.Title style={{color: 'black'}}>DayByDay</Card.Title>
        <Card.Text style={{color: 'black'}}>
        ...
        <Button variant="primary" href="https://daybyday-application.herokuapp.com/login" target="_">Check it out!</Button>
      </Card.Body>
    </Card>
      </div>
    </div>
